...
def hog_SVM(img_group: str, cell_size: int, plotting: bool=False):
    ...
    proj_dir_path: str = '../../file_output/' + 'asm5/'
    feature: str = 'hog'
    ...
    data = pd.read_csv(proj_dir_path + feature + '_' + img_group + '_' + str(cell_size) + '.csv')
    print(data.head())
    ...
    if plotting:
        ...
        # plt.show()
        PlotUtil.save_plot_to_project_folder_ver2(plt, proj_dir_path, img_group + '_' + feature + '_' + str(cell_size) +'_train_conf_mat.png')
        plt.clf()
        ...
        plt.xlabel('Predicted label')
        # plt.show()
        PlotUtil.save_plot_to_project_folder_ver2(plt, proj_dir_path, img_group + '_' + feature + '_' + str(cell_size) +'_test_conf_mat.png')
        plt.clf()
