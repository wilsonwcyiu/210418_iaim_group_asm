...
if __name__ == '__main__':
    ...
    for image_name in image_name_list:
        ...
        pixel_flattened_list = ImageUtil.obtain_pixel_value_list(curr_img)
        ...
        for layer_idx in range(0, 16):
            for width_idx in range(image_width):
                for height_idx in range(image_height):
                    ...
                    if pixel_grayscale_2d[width_idx][height_idx] > 255:
                        pixel_grayscale_2d[width_idx][height_idx] = 255


        ImageUtil.show_image_in_dip_view(pixel_grayscale_2d, title="sum projection")
